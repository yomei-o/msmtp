...
int msmtp_cmdline(msmtp_cmdline_conf_t *conf, int argc, char *argv[])
{
    ...
    for (;;)
    {
        c = mygetopt_long(argc, argv, "Pd::SC:a:f:N:R:X:tA:B:b:F:Gh:iL:mnO:o:v",
                options, NULL);
        if (c == -1)
        {
            break;
        ...
        switch(c)
        {
            ...
            case 'd':
                 ...
                 * version information */
                if (myoptarg && strcmp(myoptarg, "0.1") == 0)
                {
                    conf->print_version = 1;
                }
                break;
            ...
            case 'C':
                ...
                conf->user_conffile = xstrdup(myoptarg);
                break;
            ...
            case LONGONLYOPT_HOST:
                ...
                else
                {
                    ...
                    conf->cmdline_account->host = xstrdup(myoptarg);
                    conf->cmdline_account->mask |= ACC_HOST;
                }
                break;

            case LONGONLYOPT_PORT:
                conf->cmdline_account->port = get_pos_int(myoptarg);
            ...
            case LONGONLYOPT_AUTO_FROM:
                if (!myoptarg || is_on(myoptarg))
                {
                    conf->cmdline_account->auto_from = 1;
                }
                else if (is_off(myoptarg))
                {
            ...
            case 'f':
                ...
                else
                {
                     ...
                     * bug 612679. */
                    if (strcmp(myoptarg, "<>") == 0)
                    {
                        conf->cmdline_account->from = xstrdup("");
                    }
                    else
                    {
                        conf->cmdline_account->from = xstrdup(myoptarg);
                    }
            ...
            case LONGONLYOPT_MAILDOMAIN:
                ...
                conf->cmdline_account->maildomain =
                    (*myoptarg == '\0') ? NULL : xstrdup(myoptarg);
            ...
            case LONGONLYOPT_AUTH:
                ...
                else if (check_auth_arg(myoptarg) == 0)
                {
                    conf->cmdline_account->auth_mech = xstrdup(myoptarg);
                }
                else
                {
                    conf->cmdline_account->auth_mech = NULL;
            ...
            case LONGONLYOPT_TLS_FINGERPRINT:
                ...
                if (*myoptarg)
                {
                    if (strlen(myoptarg) == 2 * 20 + 19)
                    {
                        conf->cmdline_account->tls_sha1_fingerprint =
                            get_fingerprint(myoptarg, 20);
                    }
                    else if (strlen(myoptarg) == 2 * 16 + 15)
                    {
                        conf->cmdline_account->tls_md5_fingerprint =
                            get_fingerprint(myoptarg, 16);
                    }
                    if (!conf->cmdline_account->tls_sha1_fingerprint
                            && !conf->cmdline_account->tls_md5_fingerprint)
                    {
                        print_error(_("invalid argument %s for %s"),
                                myoptarg, "--tls-fingerprint");
                        error_code = 1;
                    }
                }
            ...
            case LONGONLYOPT_TLS_KEY_FILE:
                ...
                if (*myoptarg)
                {
                    conf->cmdline_account->tls_key_file = expand_tilde(myoptarg);
                }
                else
                {
            ...
            case LONGONLYOPT_TLS_CERT_FILE:
                ...
                if (*myoptarg)
                {
                    conf->cmdline_account->tls_cert_file = expand_tilde(myoptarg);
                }
                else
                {
            ...
            case LONGONLYOPT_TLS_MIN_DH_PRIME_BITS:
                ...
                else
                {
                    ...
                    {
                        print_error(_("invalid argument %s for %s"),
                                myoptarg, "--tls-min-dh-prime-bits");
                        error_code = 1;
                    }
                }
            ...
            case LONGONLYOPT_TLS_PRIORITIES:
                ...
                if (*myoptarg)
                {
                    conf->cmdline_account->tls_priorities = xstrdup(myoptarg);
                }
                else
                {
            ...
            case 'N':
                ...
                else if (check_dsn_notify_arg(myoptarg) == 0)
                {
                    conf->cmdline_account->dsn_notify = xstrdup(myoptarg);
                }
                else
                {
                    print_error(_("invalid argument %s for %s"),
            ...
            case 'R':
                ...
                else if (strcmp(myoptarg, "hdrs") == 0
                        || strcmp(myoptarg, "headers") == 0)
                {
                    conf->cmdline_account->dsn_return = xstrdup("HDRS");
                }
                else if (strcmp(myoptarg, "full") == 0)
                {
            ...
            case LONGONLYOPT_PROTOCOL:
                ...
                if (strcmp(myoptarg, "smtp") == 0)
                {
                    conf->cmdline_account->protocol = SMTP_PROTO_SMTP;
                }
                else if (strcmp(myoptarg, "lmtp") == 0)
                {
            ...
            case LONGONLYOPT_DOMAIN:
                ...
                conf->cmdline_account->domain = xstrdup(myoptarg);
            ...
            case 'X':
                ...
                if (*myoptarg)
                {
                    conf->cmdline_account->logfile = expand_tilde(myoptarg);
                }
                else
                {
            ...
            case LONGONLYOPT_SYSLOG:
                ...
                {
                    if (check_syslog_arg(myoptarg) != 0)
                    {
                        print_error(_("invalid argument %s for %s"),
                                myoptarg, "--syslog");
                        error_code = 1;
                    ...
                    {
                        conf->cmdline_account->syslog = xstrdup(myoptarg);
                    }
                }
            ...
            case LONGONLYOPT_ALIASES:
                ...
                if (*myoptarg)
                {
                    conf->cmdline_account->aliases = expand_tilde(myoptarg);
                }
                else
                {
            ...
            case LONGONLYOPT_PROXY_HOST:
                ...
                if (*myoptarg)
                {
                    conf->cmdline_account->proxy_host = xstrdup(myoptarg);
                }
                else
                {
            ...
            case LONGONLYOPT_PROXY_PORT:
                if (*myoptarg)
                {
                    conf->cmdline_account->proxy_port = get_pos_int(myoptarg);
            ...
            case LONGONLYOPT_ADD_MISSING_FROM_HEADER:
                ...
                {
                    print_error(_("invalid argument %s for %s"),
                            myoptarg, "--add-missing-from-header");
                    error_code = 1;
                }
            ...
            case LONGONLYOPT_ADD_MISSING_DATE_HEADER:
                ...
                {
                    print_error(_("invalid argument %s for %s"),
                            myoptarg, "--add-missing-date-header");
                    error_code = 1;
                }
            ...
            case 'b':
                /* only m makes sense */
                if (strcmp(myoptarg, "m") != 0)
                {
                    print_error(_("unsupported operation mode b%s"), myoptarg);
                    error_code = 1;
                }
                break;
            ...
            case 'F':
                free(conf->full_name);
                conf->full_name = xstrdup(myoptarg);
                break;
